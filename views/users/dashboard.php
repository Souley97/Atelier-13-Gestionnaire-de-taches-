...
<div class="wrapper d-flex align-items-stretch">
  ...
  <div class=" container">
        ...
        foreach ($myProjets  as $projet) { ?>
          ...
          <div class="col-md-4 radio   mb-4 ">
            <div class="card p-3 mb-2 box">
              ...
              <div class="mt-1">
                <a href="detailProjet?id=<?= $projet['id'] ?>/<?= $projet['name']  ?>"  class="heading   "><?= $projet['project_name']  ?></a>
                <div class="mt-2">
                  <div class="progress">
    ...
    // require_once '../projets/update.php';
    // require_once '../taches/create.php';
    require_once '../projets/create.php';
