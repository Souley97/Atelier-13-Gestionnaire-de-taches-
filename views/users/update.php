    ...
    <div class="row">
        ...
        <div class="col-md-9 register-right">
            <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Modifier</a>
                </li>
                <li class="nav-item">
                </li>
            </ul>
            <form id="myForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="tab-content" id="myTabContent myForm">
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="row register-form">
                        ...
                        <input type="submit" name="updateUser" class="btnRegister" value="Modifier" />
                        </div>
                    </div>
                </div>
